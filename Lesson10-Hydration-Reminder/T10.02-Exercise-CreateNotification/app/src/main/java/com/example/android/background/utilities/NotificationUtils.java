...
public class NotificationUtils {
    private static final int PENDING_INTENT_ID = 5000;
    private static final int NOTIFICATION_ID = 4355;
        ...
        public static void remindUserBecauseCharging(Context context) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context,WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
                        ...
                        .setContentIntent(triggerIntent(context))
                        .setAutoCancel(true);
    ...
    private static PendingIntent triggerIntent(Context context) {
        Intent ActivityIntent = new Intent(context, MainActivity.class);
        PendingIntent triggerIntent = PendingIntent.getActivity(context, PENDING_INTENT_ID,ActivityIntent,PendingIntent.FLAG_UPDATE_CURRENT);
